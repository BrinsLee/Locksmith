...
class KnownAppNames {
    companion object {
        ...
        private fun makeKnownNames(): Map<String, String> {
            ...
            m.put("apple.com", "apple.com")
            m.put("apple", "apple.com")
            m.put("苹果", "apple.com")
            m.put("samsung.com", "samsung.com")
            m.put("samsung", "samsung.com")
            m.put("三星", "samsung.com")
            m.put("huawei.com", "huawei.com")
            m.put("huawei", "huawei.com")
            m.put("华为", "huawei.com")
            m.put("xiaomi.com", "xiaomi.com")
            m.put("xiaomi", "xiaomi.com")
            m.put("小米", "xiaomi.com")
            m.put("oppo.com", "oppo.com")
            m.put("oppo", "oppo.com")
            m.put("欧珀", "oppo.com")
            m.put("vivo.com", "vivo.com")
            m.put("vivo", "vivo.com")
            m.put("维沃", "vivo.com")
            m.put("oneplus.com", "oneplus.com")
            m.put("oneplus", "oneplus.com")
            m.put("一加", "oneplus.com")
            m.put("meizu.com", "meizu.com")
            m.put("meizu", "meizu.com")
            m.put("魅族", "meizu.com")
            ...
            m.put("coolapk.com", "coolapk.com")
            m.put("coolapk", "coolapk.com")
            m.put("酷安", "coolapk.com")
            return m
        }
    }
}
